                    ...
                    <form action="<?= base_url('registrasi/tambah'); ?>" id="formRegist" enctype="multipart/form-data" method="post">
                            ...
                            <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label class="form-control-label" for="nama_lengkap"><span class="text-danger">*</span>Nama Lengkap</label>
                                                <input type="text" id="nama_lengkap" class="form-control" name="nama_lengkap">
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label class="form-control-label" for="no_ktp"><span class="text-danger">*</span>No KTP</label>
                                                <input type="text" id="no_ktp" class="form-control" name="no_ktp">
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label class="form-control-label" for="email"><span class="text-danger">*</span>Email</label>
                                                <input type="text" id="email" class="form-control" name="email">
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label class="form-control-label" for="tempat_lahir"><span class="text-danger">*</span>Tempat Lahir</label>
                                                <input type="text" id="tempat_lahir" class="form-control" name="tempat_lahir">
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label class="form-control-label" for="tgl_lahir"><span class="text-danger">*</span>Tanggal Lahir</label>
                                                <input type="date" id="tgl_lahir" class="form-control" name="tgl_lahir">
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label class="form-control-label" for="gender"><span class="text-danger">*</span>Status Perkawinan</label>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label class="form-control-label" for="no_hp"><span class="text-danger">*</span>No HP</label>
                                ...
                                <div class="col-md-8">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="form-control-label" for="status_kawin"><span class="text-danger">*</span>Status Perkawinan</label>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="form-control-label" for="agama"><span class="text-danger">*</span>Agama</label>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="form-control-label" for="kewarganegaraan"><span class="text-danger">*</span>Kewarganegaraan</label>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <label for="alamat_asli" class="form-control-label"><span class="text-danger">*</span>Alamat Sesuai KTP</label>
                                            <textarea name="alamat_asli" id="alamat_asli" cols="30" rows="5" class="form-control"></textarea>
                                        </div>
                                        <div class="col-md-6">
                                            <label for="alamat_domisili" class="form-control-label"><span class="text-danger">*</span>Alamat Sesuai Domisili</label>
                                            <textarea name="alamat_domisili" id="alamat_domisili" cols="30" rows="5" class="form-control"></textarea>
                                        </div>
                                    </div>
                                    <div class="row mt-4">
                                        <div class="col-md-6">
                                            <label for="kir" class="form-control-label"><span class="text-danger">*</span>Upload Surat Keterangan Sehat</label>
                                            <input type="file" name="kir" id="kir" class="form-control" required>
                                        </div>
                                        <div class="col-md-6">
                                            <label for="kir" class="form-control-label"><span class="text-danger">*</span>Upload KTP</label>
                                            <input type="file" name="ktp" id="ktp" class="form-control" required>
                                        </div>
                                    </div>
                                    <div class="row mt-4">
                                        <div class="col-md-6">
                                            <label for="cv" class="form-control-label"><span class="text-danger">*</span>Upload Your CV</label>
                                            <input type="file" name="cv" id="cv" class="form-control" required />
                                        </div>
                                        <div class="col-md-6">
                                            <label for="foto" class="form-control-label"><span class="text-danger">*</span>Upload Your Photos</label>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label class="form-control-label" for="alasan_berhenti">Sertifikat</label>
                        ...
                        <div class="pl-lg-4 tabcontent" id="tab3">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label class="form-control-label" for="password2"><span class="text-danger">*</span>Konfirmasi Password</label>
